...
properties = {
	...
	"task.documentation": {"if": "branch = master", "env": ["TASK=documentation"], "addons": addon_apt([],["doxygen", "ghostscript", "latex-xcolor", "lmodern", "pgf", "texinfo", "texlive", "texlive-font-utils", "texlive-latex-extra", "python3-pip"])},
