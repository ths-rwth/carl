...
properties = {
	...
	"task.documentation": {"if": "branch = master", "env": ["TASK=documentation"], "addons": addon_apt([],["doxygen", "ghostscript", "graphviz", "lmodern", "texinfo", "texlive", "texlive-font-utils", "texlive-latex-extra", "texlive-plain-generic", "python3-pip", "python3-setuptools"])},
