...
add_imported_library(GMP SHARED "${INSTALL_DIR}/lib/libgmp${DYNAMIC_EXT}" "${INSTALL_DIR}/include")
add_imported_library(GMP STATIC "${INSTALL_DIR}/lib/libgmp${STATIC_EXT}" "${INSTALL_DIR}/include")
add_imported_library(GMPXX SHARED "${INSTALL_DIR}/lib/libgmpxx${DYNAMIC_EXT}" "${INSTALL_DIR}/include")
add_imported_library(GMPXX STATIC "${INSTALL_DIR}/lib/libgmpxx${STATIC_EXT}" "${INSTALL_DIR}/include")
