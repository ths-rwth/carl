...
set(BOOST_OPTIONS --without-atomic --without-context --without-coroutine --without-fiber --without-filesystem --without-iostreams --without-locale --without-log --without-mpi --without-python --without-random --without-regex --without-thread --without-wave)

ExternalProject_Add(
	Boost-EP
	URL https://boostorg.jfrog.io/ui/native/main/release/${Boost_VERSION}/source/boost_${BOOST_VERSION_FILENAME}.zip
	URL_SHA256 ${Boost_ZIPHASH}
	BUILD_IN_SOURCE 1
