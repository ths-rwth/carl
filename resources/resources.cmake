...
function(print_resource_info name target version)
	if(TARGET ${target})
		...
		if(TYPE STREQUAL "SHARED_LIBRARY")
			get_target_property(LIBRARY ${target} IMPORTED_LOCATION)
			get_target_property(INCLUDE ${target} INTERFACE_INCLUDE_DIRECTORIES)
		elseif(TYPE STREQUAL "STATIC_LIBRARY")
			get_target_property(LIBRARY ${target} IMPORTED_LOCATION)
			get_target_property(INCLUDE ${target} INTERFACE_INCLUDE_DIRECTORIES)
		elseif(TYPE STREQUAL "INTERFACE_LIBRARY")
			get_target_property(LIBRARY ${target} INTERFACE_LINK_LIBRARIES)
			get_target_property(INCLUDE ${target} INTERFACE_INCLUDE_DIRECTORIES)
		endif()
		if(LIBRARY)
			message(STATUS "${name} ${version} was found at ${INCLUDE} and ${LIBRARY}")
		else()
			message(STATUS "${name} ${version} was found at ${INCLUDE}")
		endif()
	else()
