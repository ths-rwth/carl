...
export(EXPORT carl-targets FILE "${PROJECT_BINARY_DIR}/carlTargets.cmake")
...
if(RAN_USE_Z3 OR USE_Z3_NUMBERS OR COMPARE_WITH_Z3)
	export_target(DEP_TARGETS Z3_SHARED GMPXX_SHARED GMP_SHARED pthread)
	export_target(DEP_TARGETS Z3_STATIC GMPXX_STATIC GMP_STATIC pthread)
endif()
if(USE_MIMALLOC)
	export_target(DEP_TARGETS MIMALLOC_OBJECT)
	export_target(DEP_TARGETS MIMALLOC_SHARED GMPXX_SHARED GMP_SHARED pthread)
	export_target(DEP_TARGETS MIMALLOC_STATIC GMPXX_STATIC GMP_STATIC pthread)
endif()
