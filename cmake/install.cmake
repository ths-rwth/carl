...
if(${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION} VERSION_GREATER 3.0)
	...
	install(FILES ${CMAKE_CURRENT_BINARY_DIR}/carlConfig.cmake DESTINATION ${CMAKE_INSTALL_DIR})
	install(FILES ${CMAKE_CURRENT_BINARY_DIR}/carlTargets.cmake DESTINATION ${CMAKE_INSTALL_DIR})
else()
