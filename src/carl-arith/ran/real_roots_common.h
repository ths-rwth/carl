...
namespace carl::ran {
    ...
    private:
        ...
        real_roots_result(nullified_t) : m_data(nullified_t{}) {};
        real_roots_result(non_univariate_t) : m_data(non_univariate_t{}) {};
        real_roots_result(roots_t&& real_roots) : m_data(std::move(real_roots)) {};
