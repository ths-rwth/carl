		...
		bool isTrivialTrue() const  {
			if(mLhs.isConstant())
			{
				...
				if(cp == 0) {
					...
					return mRelation == Relation::GEQ || mRelation == Relation::GT || mRelation == Relation::NEQ;
				} else {
					assert(cp < 0);
					return mRelation == Relation::LEQ || mRelation == Relation::LT || mRelation == Relation::NEQ;
				}
			}
			return false;
		}
		...
		bool isTrivialFalse() const {
			if(mLhs.isConstant())
			{
				...
				if(cp == 0) {
					...
					return mRelation == Relation::LEQ || mRelation == Relation::LT || mRelation == Relation::EQ;
				} else {
					assert(cp < 0);
					return mRelation == Relation::GEQ || mRelation == Relation::GT || mRelation == Relation::EQ;
				}
			}
			return false;
		}
