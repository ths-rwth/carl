...
#define DOUBLE_BOUNDS_OK( left, leftType, right, rightType )\
        ...
        public:
             ...
             * @param rightType
             */
            DoubleInterval( const double left, BoundType leftType, const double right, BoundType rightType );

            /**
             * Creates a DoubleInterval from passed numerics by converting them to a double and over-approximating this
             * conversion by the smallest possible double on both bounds.
             * @param left
             * @param leftType
             * @param right
             * @param rightType
             * @param overapproximate compute the approximations of the given bounds so that the interval is an over-approximation of the corresponding OpenInterval; otherwise under-approximate (default: false)
             */
            DoubleInterval( const cln::cl_RA& left, BoundType leftType, const cln::cl_RA& right, BoundType rightType, bool = false, bool = false );
