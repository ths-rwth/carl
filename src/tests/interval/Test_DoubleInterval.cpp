...
TEST(DoubleInterval, Contains)
{
    ...
    EXPECT_TRUE(set_proper_subset(i1, i3));
    EXPECT_FALSE(set_proper_subset(i3, i1));
    EXPECT_FALSE(set_proper_subset(i1, i5));
    EXPECT_TRUE(set_proper_subset(i5, i1));
    EXPECT_TRUE(set_proper_subset(i1, i6));
    EXPECT_FALSE(set_proper_subset(i6, i1));
    EXPECT_FALSE(set_proper_subset(i6, i6));
    EXPECT_FALSE(set_proper_subset(i1, i1));
    EXPECT_FALSE(set_proper_subset(i1, i7));
    EXPECT_TRUE(set_proper_subset(i7, i1));
    EXPECT_FALSE(set_proper_subset(i6, i7));
    EXPECT_TRUE(set_proper_subset(i7, i6));
    EXPECT_FALSE(set_proper_subset(i8, i5));
    EXPECT_TRUE(set_proper_subset(i5, i8));
    EXPECT_FALSE(set_proper_subset(i8, i6));
    EXPECT_TRUE(set_proper_subset(i6, i8));
    EXPECT_FALSE(set_proper_subset(i8, i4));
    EXPECT_FALSE(set_proper_subset(i4, i8));
}
