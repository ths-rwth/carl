...
TYPED_TEST(IntervalRationalTest, Constructor) {
	...
	Interval test1 = Interval(-1, BoundType::WEAK, 1, BoundType::WEAK);
	Interval test2 = Interval(-1, BoundType::STRICT, 1, BoundType::STRICT);
	Interval test3 = Interval(-1, BoundType::INFTY, 1, BoundType::INFTY);
	EXPECT_EQ(Interval(1, BoundType::WEAK, -1, BoundType::WEAK), Interval::emptyInterval());
	Interval test5 = Interval::unboundedInterval();
	Interval test6 = Interval::emptyInterval();

	Interval test7 = Interval((mpq_class)-1, BoundType::WEAK, (mpq_class)1, BoundType::WEAK);

	Interval test8 = Interval(2, BoundType::STRICT, 0, BoundType::INFTY);
	Interval test9 = Interval(1);
	Interval test10 = Interval(0);
}

TYPED_TEST(IntervalRationalTest, Getters) {
	using Interval = Interval<TypeParam>;
	Interval test1 = Interval(-1.0, BoundType::WEAK, 1.0, BoundType::STRICT);
	Interval test2 = Interval(-1, BoundType::WEAK, 1, BoundType::STRICT);
	Interval test3 = Interval(1, BoundType::STRICT, 1, BoundType::STRICT);
	Interval test4 = Interval(4, BoundType::WEAK, 2, BoundType::WEAK);
	Interval test5 = Interval();
	Interval test6 = Interval(4);
	Interval test7 = Interval(1);
	Interval test8 = Interval(0);
	...
	test1.set(typename Interval::BoostInterval(3, 27));
	EXPECT_EQ(3, test1.lower());
	...
	test2 = Interval();
	typename Interval::BoostInterval bi(0, 1);
	bi = boost::numeric::widen(bi, TypeParam(-3)); // create an invalid interval by this hack
	test2.set(bi);
	EXPECT_EQ(0, test2.lower());
	EXPECT_EQ(0, test2.upper());
	EXPECT_TRUE(test2.isEmpty());

	test2 = Interval(bi, BoundType::WEAK, BoundType::WEAK);
	EXPECT_EQ(0, test2.lower());
	EXPECT_EQ(0, test2.upper());
	EXPECT_TRUE(test2.isEmpty());
...
TYPED_TEST(IntervalRationalTest, StaticCreators) {
	using Interval = Interval<TypeParam>;
	Interval i1 = Interval::emptyInterval();
	Interval i2 = Interval::unboundedInterval();
	Interval i3 = carl::constant_one<Interval>().get();
	Interval i4 = carl::constant_zero<Interval>().get();
...
TYPED_TEST(IntervalRationalTest, Addition)
{
...
TYPED_TEST(IntervalRationalTest, Subtraction)
{
	clRA_Interval a0 = clRA_Interval( -1, BoundType::INFTY, 2, BoundType::WEAK);
	clRA_Interval a1 = clRA_Interval( -1, BoundType::WEAK, 2, BoundType::WEAK);
	clRA_Interval a2 = clRA_Interval( -1, BoundType::WEAK, 1, BoundType::INFTY);
...
TYPED_TEST(IntervalRationalTest, Multiplication)
{
...
TYPED_TEST(IntervalRationalTest, ExtendedDivision)
{
...
TYPED_TEST(IntervalRationalTest, Intersection)
{
...
TYPED_TEST(IntervalRationalTest, Union)
{
...
TYPED_TEST(IntervalRationalTest, Split)
{
...
TYPED_TEST(IntervalRationalTest, Properties)
{
...
TYPED_TEST(IntervalRationalTest, Contains)
{
	clRA_Interval i1(3, BoundType::STRICT, 7, BoundType::STRICT);
	clRA_Interval i2(-5, BoundType::STRICT, 3, BoundType::WEAK);
	clRA_Interval i3(3, BoundType::WEAK, 7, BoundType::STRICT);
...
TYPED_TEST(IntervalRationalTest, BloatShrink)
{
