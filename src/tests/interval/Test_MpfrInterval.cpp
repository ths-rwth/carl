...
TEST(mpfrInterval, Constructor)
{
    ...
    EXPECT_EQ(mpfrInterval(1, BoundType::WEAK, -1, BoundType::WEAK), mpfrInterval::empty_interval());
    mpfrInterval test5 = mpfrInterval::unbounded_interval();
    mpfrInterval test6 = mpfrInterval::empty_interval();
	/*
...
{
    mpfrInterval i1 = mpfrInterval::empty_interval();
    mpfrInterval i2 = mpfrInterval::unbounded_interval();
...
TEST(mpfrInterval, Addition)
{
    ...
    EXPECT_EQ( mpfrInterval(4, BoundType::INFTY, 4, BoundType::WEAK), result);
    result = a0.add(b2);
	EXPECT_EQ( mpfrInterval::unbounded_interval(), result);
    result = a0.add(b3);
    EXPECT_EQ( mpfrInterval::unbounded_interval(), result);
...
TEST(mpfrInterval, ExtendedDivision)
{
    ...
    EXPECT_EQ( mpfrInterval::empty_interval(), result1 );
    a1.div_ext( b4, result1, result2 );
    EXPECT_EQ( mpfrInterval::unbounded_interval(), result1 );
...
TEST(mpfrInterval, Intersection)
{
    ...
    EXPECT_EQ(mpfrInterval::empty_interval(), carl::set_intersection(a1, b01));
    ...
    EXPECT_EQ(mpfrInterval::empty_interval(), carl::set_intersection(a1, b07));
    ...
    EXPECT_EQ(mpfrInterval::empty_interval(), carl::set_intersection(a1, b14));
