...
void define_rational(py::module& m) {
    py::class_<Rational>(m, "Rational", "Class wrapping rational numbers")
        ...
        .def("__add__", [](const Rational& lhs, int rhs) -> Rational { return lhs + carl::rationalize<Rational>(rhs); })
        .def("__radd__", [](const Rational& rhs, double lhs) -> Rational { return carl::rationalize<Rational>(lhs) + rhs; })
        .def("__radd__", [](const Rational& rhs, int lhs) -> Rational { return carl::rationalize<Rational>(lhs) + rhs; })
        ...
        .def("__sub__", [](const Rational& lhs, int rhs) -> Rational { return lhs - carl::rationalize<Rational>(rhs); })
        .def("__rsub__", [](const Rational& rhs, double lhs) -> Rational { return carl::rationalize<Rational>(lhs) - rhs; })
        .def("__rsub__", [](const Rational& rhs, int lhs) -> Rational { return carl::rationalize<Rational>(lhs) - rhs; })
        ...
        .def("__mul__", [](const Rational& lhs, int rhs) -> Rational { return lhs * carl::rationalize<Rational>(rhs); })
        .def("__rmul__", [](const Rational& rhs, double lhs) -> Rational { return carl::rationalize<Rational>(lhs) * rhs; })
        .def("__rmul__", [](const Rational& rhs, int lhs) -> Rational { return carl::rationalize<Rational>(lhs) * rhs; })
        ...
        .def(PY_DIV, [](const Rational& lhs, const Rational& rhs) -> Rational { if (rhs == 0.0) throw std::runtime_error("Div by zero"); return lhs / rhs; })
        ...
        .def(PY_DIV, [](const Rational& lhs, int rhs) -> Rational { if (rhs == 0.0) throw std::runtime_error("Div by zero"); return lhs / carl::rationalize<Rational>(rhs); })
        .def(PY_RDIV, [](const Rational& rhs, double lhs) -> Rational { if (rhs == 0.0) throw std::runtime_error("Div by zero"); return carl::rationalize<Rational>(lhs) / rhs; })
        .def(PY_RDIV, [](const Rational& rhs, int lhs) -> Rational { if (rhs == 0.0) throw std::runtime_error("Div by zero"); return carl::rationalize<Rational>(lhs) / rhs; })
