...
void define_variable(py::module& m) {
    ...
    py::class_<carl::Variable>(m, "Variable")
        ...
        .def("__mul__", [](carl::Variable::Arg lhs, int rhs) { return lhs * carl::rationalize<Rational>(rhs); })
        .def("__rmul__", [](carl::Variable::Arg rhs, double lhs) { return carl::rationalize<Rational>(lhs) * rhs; })
        .def("__rmul__", [](carl::Variable::Arg rhs, int lhs) { return carl::rationalize<Rational>(lhs) * rhs; })
